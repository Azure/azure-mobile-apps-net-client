...
namespace MobileClient.Tests.Table.Sync
{
    public class PullActionTests
    {
        ...
        public async Task SavesTheMaxUpdatedAt_IfQueryIdIsSpecified_WithoutFilter()
        {
            ...
            var action = new PullAction(table.Object, MobileServiceTableKind.Table, context.Object,
                queryName, query, null, null, opQueue.Object, settings.Object, store.Object,
