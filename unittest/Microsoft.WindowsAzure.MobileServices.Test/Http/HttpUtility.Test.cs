...
namespace Microsoft.WindowsAzure.MobileServices.Test.Http
{
    [TestClass]
    public class HttpUtility_Test
    {
        [TestMethod]
        public void TryParseQueryUri_ReturnsTrue_WhenQueryIsRelativeOrAbsoluteUri()
        {
            var data = new[]
{
                new
        ...
        [TestMethod]
        public void TryParseQueryUri_ReturnsFalse_WhenQueryIsNotRelativeOrAbsoluteUri()
        {
            var data = new[]
            {
                new
