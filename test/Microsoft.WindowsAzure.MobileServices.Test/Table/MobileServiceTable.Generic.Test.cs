...
namespace Microsoft.WindowsAzure.MobileServices.Test.Table
{
    ...
    public class MobileServiceTable_Generic_Test
    {
        ...
        [TestMethod] // this is the default buggy behavior that we've already shipped
        ...
        [TestMethod] // user has to set the serializer setting to round trip dates in string fields correctly
...
#pragma warning restore CS0472 // The result of the expression is always the same since a value of this type is never equal to 'null'
        ...
        public async Task LookupAsyncWithUserParameters()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "12");
            StringAssert.Contains(hijack.Request.RequestUri.Query, "state=CA");
        ...
        public async Task InsertAsyncGenericWithUserParameters()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "StringType");
            StringAssert.Contains(hijack.Request.RequestUri.Query, "state=CA");
        }
        ...
        public async Task DeleteAsyncWithUserParameters()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.Query, "state=WY");
        }
        ...
        public async Task IncludeDeleted()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "StringType");
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "__includeDeleted=true");
        ...
        public async Task IncludeTotalGenericList()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "StringType");
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "$inlinecount=allpages");
        ...
        public async Task WhereAsyncWithStringIdGeneric()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "StringIdType");
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "$filter=(id eq '12')");
        ...
        public async Task OrderByAsyncGeneric()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "StringType");
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "orderby=id,String");
        }
        ...
        public async Task OrderByDoubleAsyncGeneric()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "StringType");
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "orderby=String,id");
        }
        ...
        public async Task OrderByDescAsyncGeneric()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "StringType");
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "orderby=id desc,String desc");
        }
        ...
        public async Task OrderByAscDescAsyncGeneric()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "StringType");
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "orderby=id,String desc");
        }
        ...
        public async Task SkipAndTakeAsyncGeneric()
        {
            ...
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "StringType");
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "$skip=100");
            StringAssert.Contains(hijack.Request.RequestUri.ToString(), "$top=10");
        }
